...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-rawtxpath", strprintf("Specify path to the text file with saved unsigned transactions", DEFAULT_WALLET_REJECT_LONG_CHAINS), false, OptionsCategory::WALLET);
